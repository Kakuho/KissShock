...
namespace Sample{
  class PongBall: public KissShock::Body{
    public:
      ...
      friend constexpr void PongBallOnPongWall(KissShock::Body& ball);
  };

  std::size_t PongBall::Id = 0;

  // implementation of the resolution handlers

  constexpr void PongBallOnPongWall(KissShock::Body& ball){
  ...
  class PongWall: public KissShock::Body{
    public:
      ...
      friend constexpr void PongWallOnPongBall(KissShock::Body& ball, KissShock::Body& wall);
  };
